import MR from "../../../../Assests/Webdesign/8-u.jpg"
  ...
  return (
    ...
    <div className="col-md-12 col-lg-6 mt-o mt-md-5 d-flex flex-column justify-content-center p-4 p-md-5 h-100">
        ...
        <div>
            ...
            Adaptive mobile design solutions can help you embrace the mobile age. With our websites,
             you may browse content on all devices with maximum ease and comfort regardless of screen size.
             </p>
        </div>
    </div>
    <div className="col-md-12 col-lg-6 d-flex justify-content-center align-items-center p-0" style={{ borderRight: "1px solid" }}>
        <img src={MR} alt="discover our story" className="w-100 h-100" />
    </div>
</div>
</div>
  );
