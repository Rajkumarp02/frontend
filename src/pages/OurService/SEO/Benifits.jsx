import b1 from "../../../Assests/Ourservice/seo/i-1.jpg";
import b2 from "../../../Assests/Ourservice/seo/i-2.jpg";
import b3 from "../../../Assests/Ourservice/seo/i-3.jpg";
import b4 from "../../../Assests/Ourservice/seo/i-4.jpg";
import b5 from "../../../Assests/Ourservice/seo/i-5.jpg";
import "./SEO.css";
   ...
   <div className="container-fluid p-md-3">
    <div className="row p-md-5 mb-4 column-gap-5">
        <div className="text-center d-flex justify-content-center align-items-center">
             <h3 className="p-md-2 mb-5 b-text">Benefits Of SEO</h3>
        </div>
